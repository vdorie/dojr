...
#stat.jurisd$ncic_jurisdiction[stat.jurisd$bookMatchPct > 1]
  ...
  plot(log(stat.jurisd$repBookTot), stat.jurisd$actualBookTot/stat.jurisd$repBookTot, ylim=c(0,1), main="proportion of matched bookings by arrest volume", xlab="ln(department arrests)", ylab = "proportion of reported bookings matched")
