...
gridRatio <- knitr::opts_knit$get("rmarkdown.pandoc.to")
gridRatio <- if (is.null(gridRatio) || gridRatio == "html") 1.6 else 8.5 / 11
```
...
```{r loading}
load("macr_clean.Rdata") ## defines 'macr' object
