...
```{r 'preface_include', child = if (file.exists(abstractFile <- file.path(datasetDir, "preface.Rmd"))) abstractFile else NULL }
```
...
if (nrow(variables) > 0L) cat(pageBreak)
